...
public class RedisConstant {
	...
	public static final String IDEMPOTENCY_KEY_PREFIX = "IDEMPOTENCY_KEY:";
	public static final String IDEMPOTENCY_TRANSACTION_TOKEN_KEY_PREFIX = "IDEMPOTENCY_TRANSACTION_TOKEN_KEY:";

	public static final Duration ACCOUNT_LOCK_EXPIRATION = Duration.ofMinutes(5);
	public static final Duration IDEMPOTENCY_EXPIRATION = Duration.ofMinutes(10);
