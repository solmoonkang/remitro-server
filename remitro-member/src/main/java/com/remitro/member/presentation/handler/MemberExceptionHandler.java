package com.remitro.member.presentation.handler;
...
public class MemberExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleForbidden(ForbiddenException e) {
		log.warn("[✅ LOGGER] FORBIDDEN: CODE={}, MESSAGE={}", e.getErrorCode().getCode(), e.getMessage());
	...
	protected ResponseEntity<ErrorResponse> handleConflict(ConflictException e) {
		log.warn("[✅ LOGGER] CONFLICT: CODE={}, MESSAGE={}", e.getErrorCode().getCode(), e.getMessage());
