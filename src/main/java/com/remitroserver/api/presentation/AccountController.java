...
public class AccountController {
	...
	public ResponseEntity<AccountDetailResponse> findAccountDetail(
		...
		return ResponseEntity.ok().body(accountService.getAccountDetail(accountToken, authMember));
	}
	...
	public ResponseEntity<AccountBalanceResponse> findAccountBalance(
		...
		return ResponseEntity.ok().body(accountService.getAccountBalance(accountToken, authMember));
	}
